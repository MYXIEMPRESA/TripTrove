...
<html>
    ...
    <body>
        ...
        <p></p>
        <p></p>
        <!-- Las respuestas del servidor se escriben aqu� -->
        <div id="messages"></div>
        ...
        <script type="text/javascript">
            ...
            function send() {
                ...
                if (webSocket && webSocket.readyState === WebSocket.OPEN) {
                    ...
                    writeResponse("WebSocket no est� abierto. Por favor, abre la conexi�n antes de enviar.");
                }
            }
            ...
            function closeSocket() {
                if (webSocket) {
                    ...
                    writeResponse("WebSocket no est� definido.");
                }
            }
